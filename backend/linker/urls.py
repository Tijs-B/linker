...
from linker.trackers.views import HeatmapTileView, PhoneGpsPositionView, PositionViewSet, TrackerViewSet
...
urlpatterns = [
    ...
    path('api/heatmap/tiles/<int:z>/<int:x>/<int:y>.pbf', HeatmapTileView.as_view()),
