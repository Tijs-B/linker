...
import {
    Basis,
    CheckpointLog, ContactPerson,
    Fiche, ForbiddenArea, LoginUser,
    MapNote,
    OrganizationMember, Stats,
    Team, TeamNote,
    Tocht,
    Tracker,
    TrackerLog,
...
export const linkerApi = createApi({
    ...
    endpoints: (build) => ({
        ...
        updateContactPerson: build.mutation<ContactPerson, Partial<ContactPerson> & Pick<ContactPerson, 'id'>>({
            query: contactPerson => ({
