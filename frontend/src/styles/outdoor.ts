...
export const outdoorStyle: StyleSpecification = {
  version: 8,
  name: 'Outdoor',
  sources: {
    openmaptiles: {
  ...
  layers: [
    ...
    },
    {
      ...
      type: 'line',
      source: 'openmaptiles',
      'source-layer': 'cutline',
      layout: { visibility: 'visible' },
      paint: {
        'line-color': 'hsla(98,50%,74%,1)',
        'line-width': ['interpolate', ['linear'], ['zoom'], 13, 0, 13.5, 4, 20, 20],
      },
    },
    {
    ...
    },
    {
      ...
      layout: { 'line-join': 'round' },
      paint: {
        'line-color': 'rgba(138, 127, 117, 1)',
        'line-dasharray': [1, 0.7],
        'line-width': ['interpolate', ['exponential', 1.2], ['zoom'], 12, 0, 12.5, 1, 20, 10],
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        'line-color': 'rgba(138, 127, 117, 1)',
        'line-width': ['interpolate', ['exponential', 1.2], ['zoom'], 12, 0, 12.5, 1, 20, 5],
        'line-dasharray': [3, 3],
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        'line-color': '#fff',
        'line-width': ['interpolate', ['exponential', 1.2], ['zoom'], 12, 0, 12.5, 1.5, 20, 18],
      },
    },
    {
    ...
    },
    {
      ...
      layout: {
        ...
        'text-max-width': 9,
        'text-size': ['interpolate', ['exponential', 1.2], ['zoom'], 12, 8, 15, 12],
    ...
    },
    {
      ...
      layout: {
        ...
        'text-font': ['D-DIN Regular'],
        'text-max-width': 8,
        'text-size': ['interpolate', ['exponential', 1.2], ['zoom'], 10, 8, 15, 18],
      },
      paint: {
        'text-color': '#333',
        'text-halo-color': 'rgba(255,255,255,0.8)',
    ...
    },
    {
      ...
      layout: {
        ...
        'text-max-width': 8,
        'text-offset': [0, 0],
        'text-size': ['interpolate', ['exponential', 1.2], ['zoom'], 7, 10, 11, 14],
      },
      paint: {
        'text-color': '#333',
        'text-halo-color': 'rgba(255,255,255,0.8)',
    ...
    },
    {
      ...
      layout: {
        ...
        'text-max-width': 8,
        'text-offset': [0, 0],
        'text-size': ['interpolate', ['exponential', 1.2], ['zoom'], 7, 12, 11, 22],
    ...
    },
    {
      ...
      layout: {
        'text-field': ['to-string', ['get', 'name_en']],
        'text-font': ['D-DIN DIN-Italic'],
        'text-size': ['interpolate', ['linear'], ['zoom'], 4, 9, 6, 13],
        'text-transform': 'uppercase',
      },
      paint: {
        'text-color': '#633',
