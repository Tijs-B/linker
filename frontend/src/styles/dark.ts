...
export const darkStyle: StyleSpecification = {
  ...
  layers: [
    ...
    },
    {
      ...
      'source-layer': 'landcover',
      maxzoom: 8,
      filter: ['all', ['==', ['geometry-type'], 'Polygon'], ['==', ['get', 'subclass'], 'glacier']],
      layout: { visibility: 'visible' },
      paint: {
    ...
    },
    {
      ...
      'source-layer': 'landcover',
      minzoom: 10,
      filter: ['all', ['==', ['geometry-type'], 'Polygon'], ['==', ['get', 'class'], 'wood']],
      layout: { visibility: 'visible' },
      paint: {
    ...
    },
    {
      ...
      source: 'openmaptiles',
      'source-layer': 'landuse',
      filter: ['all', ['==', ['geometry-type'], 'Polygon'], ['==', ['get', 'class'], 'park']],
      layout: { visibility: 'visible' },
    ...
    },
    {
      ...
      'source-layer': 'place',
      maxzoom: 15,
      filter: ['all', ['==', ['geometry-type'], 'Point'], ['==', ['get', 'class'], 'suburb']],
      layout: {
        'text-anchor': 'center',
        'text-field': ['concat', ['get', 'name:latin'], '\n', ['get', 'name:nonlatin']],
        'text-font': ['Klokantech Noto Sans Regular'],
    ...
    },
    {
      ...
      'source-layer': 'place',
      maxzoom: 14,
      filter: ['all', ['==', ['geometry-type'], 'Point'], ['==', ['get', 'class'], 'village']],
      layout: {
        'icon-size': 0.4,
        'text-anchor': 'left',
        'text-field': ['concat', ['get', 'name:latin'], '\n', ['get', 'name:nonlatin']],
    ...
    },
    {
      ...
      'source-layer': 'place',
      maxzoom: 15,
      filter: ['all', ['==', ['geometry-type'], 'Point'], ['==', ['get', 'class'], 'town']],
      layout: {
    ...
    },
    {
      ...
      'source-layer': 'place',
      maxzoom: 12,
      filter: ['all', ['==', ['geometry-type'], 'Point'], ['==', ['get', 'class'], 'state']],
      layout: {
        'text-field': ['concat', ['get', 'name:latin'], '\n', ['get', 'name:nonlatin']],
        'text-font': ['Klokantech Noto Sans Regular'],
        'text-size': 10,
